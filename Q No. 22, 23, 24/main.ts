...
let fruits = ["Banana", "Mango", "Orange", "Peach", "Pear", "Apple"];
console.log("Is `apple` in fruits ?");
console.log(fruits.includes("apple")); //True.... Showing an error of includes.

// Tests whether an item is not in an Array.

console.log("Is `mango` not in fruits ?");
console.log(! fruits.includes("mango")); // True .... Showing an error of includes.
